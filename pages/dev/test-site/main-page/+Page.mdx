...
<div class="new_container container-fluid half-height-row white-container">
    ...
    <div class="col-sm-4">
      <div class="footer-link-container">
        <ul class="footer-links">
          <li><a href="/dev/test-site/main-page">Home</a></li>
          <li><a href="/dev/test-site/explore">Explore</a></li>
          <li><a href="/dev/test-site/privacy">Privacy policy</a></li>
          <li><a href="/dev/test-site/terms_and_conditions">Terms and conditions</a></li>
        </ul>
      </div>
    </div>
  </div>
