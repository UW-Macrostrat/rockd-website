...
<div class="container field">
  <div class="mask">
    <div class="row row-eq-height">
      ...
      <div class="col-sm-6">
        <Image src="main-page/main.png"></Image>
      </div>
    </div>
  </div>
</div>
...
<div class="container white-container">
  <div class="row">
    ...
    <div class="col-xs-12 dashboard-img-container">
      ...
      <Image src="main-page/hueco-formation.png"></Image>

      <Image src="main-page/south-island-new-zealand.png"></Image>
      <Image src="main-page/colombia.png"></Image>
      <Image src="main-page/hobart-tasmania.png"></Image>
      <Image src="main-page/nacimiento-franciscan.png"></Image>

      <Image src="main-page/santa-maria-brazil.png"></Image>
      <Image src="main-page/mesa-verde.png"></Image>
      <Image src="main-page/santa-barbara.png"></Image>

      <Image src="main-page/hualalai-hawaii.png"></Image>
...
<div class="container red_rock">
  <div class="row row-eq-height">
    <div class="col-sm-6 stats-container">
      <Image src="main-page/profile.png"></Image>
    </div>
...
<div class="record-block">
  <div class="row">
    ...
    <div class="col-sm-6">
      <div class="headline-alligner">
        <div class="center">
          <Image src="main-page/checkin.png"></Image>
    ...
    <div class="col-sm-6">
      <div class="headline-alligner">
        <div class="center">
          <Image src="main-page/strat-names.png"></Image>
    ...
    <div class="col-sm-6">
      <div class="headline-alligner">
        <div class="center">
          <Image src="main-page/strike-dip.png"></Image>
    ...
    <div class="col-sm-6">
      <div class="headline-alligner">
        <div class="center">
          <Image src="main-page/taxa.png"></Image>
