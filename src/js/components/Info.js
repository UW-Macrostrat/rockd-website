    ...
    return (
      <div className="info-container">
        <div className="trip-meta">
          <img
            src={
              Constants.ROCKD_API_URL + "/protected/gravatar/" + trip.person_id
            }
        ...
        <p className={trip.description ? "trip-description" : "hidden"}>
          {trip.description}
        </p>
        <Button
          className="download-kmz"
          size="small"
          variant="outlined"
          href={
            "https://rockd.org/api/v2/trips/" + trip.trip_id + "?format=kmz"
          }
          target="_blank"
        >
          Download KMZ
